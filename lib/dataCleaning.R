...
# Read in files
setwd("/Users/timxie/Documents/GitHub/Spr2017-proj2-grp10")
...
educ_update$ACT <- educ$ACTCMMID
educ_update$Enrollment <- educ$UGDS
...
dat <- dat[,c(seq(1,25,1),28,29,30,31,26,27)]
